...
class FlaskappTests(unittest.TestCase):
    ...
    def test_updusers_status_code(self):
        ...
        # on the specified path
        result = self.app.put('/api/v1/users/24', data='{"username":"asmaul99", "email": "asmaul99@husna"}', content_type='application/json')
        # assert the status code of the response
        self.assertEquals(result.status_code, 200)
    def test_addtweets_status_code(self):
        # sends HTTP GET request to the application
        # on the specified path
        result = self.app.post('/api/v2/tweets', data='{"username":"lala", "body": "It Works!#Awesome"}', content_type='application/json')
    ...
    def test_delusers_status_code(self):
        ...
        # on the specified path
        result = self.app.delete('/api/v1/users', data='{"username":"uwuwuwu"}', content_type='application/json')
        print (result)
        # assert the status code of the response
        self.assertEquals(result.status_code, 200)
